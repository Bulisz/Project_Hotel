...
public record UserDetailsForAdmin
{
    [Required]
    ...
    [Required]
    [RegularExpression("^(Admin|Operator|Guest)$", ErrorMessage = "Admin, Operator vagy Guest lehet")]
    ...
    [Required]
    [RegularExpression("^(True|False)$", ErrorMessage = "True vagy False lehet")]
